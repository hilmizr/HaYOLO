...
class GSConv(nn.Module):
    ...
    def __init__(self, c1, c2, k=1, s=1, g=1, act=True):
        super().__init__()
        c_ = c2 // 2
        # Explicitly pass arguments using keywords to avoid positional mistakes:
        self.cv1 = Conv(c1, c_, k=k, s=s, p=None, g=g, d=1, act=act)
        self.cv2 = Conv(c_, c_, k=5, s=1, p=None, g=c_, d=1, act=act)
